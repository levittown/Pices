...
bool  KKStr::StartsWith (const char*  value)  const
{
  ...
  kkuint32  valueLen = strlen (value);
  if  (valueLen < 1)
    return true;
...
KKB::kkuint32  KKStr::ExtractTokenUint (const char* delStr)
{
  #ifdef  KKDEBUG
  ValidateLen ();
  #endif
...
KKB::kkuint32 KKStr::ToUint () const
{
  if  (!val)  return 0;
...
KKStr  KKB::StrFromInt16 (int16 i)
{
  char  buff[50];
