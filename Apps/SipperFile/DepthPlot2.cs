...
namespace SipperFile
{
	...
	/// </summary>
	public class DepthPlot2 : System.Windows.Forms.Form
	{
    ...
    private DepthPlot2Parameters  chartParms      = null;
    ...
    private string                dataWindowConfigFileName = "";
		...
		public  DepthPlot2 (SipperConfigRec     _sipperConfigRec,
      ...
      chartParms = new DepthPlot2Parameters (ChartPanel, rulers, domainScrollBar, fieldIdxs, history);

      chartParms.UpdateMinMaxValues (minValues, maxValues);

      chartParms.AssignSeriesToPlot (plotData);
      ...
      this.ChartPanel.Size = new System.Drawing.Size (620, 470);
      ...
      // depthRange
      // 
      this.depthRange.Location = new System.Drawing.Point (30, 556);
      ...
      this.depthRange.SelectedOption = "150 Meters";
      this.depthRange.SelectedOptionInt = 5;
      this.depthRange.Size = new System.Drawing.Size (96, 183);
      ...
      this.data0Ruler.Location = new System.Drawing.Point (291, 30);
      ...
      this.data0Ruler.Size = new System.Drawing.Size (620, 40);
      ...
      this.ClientSize = new System.Drawing.Size (968, 765);
    ...
    void  LoadConfiguration ()
    {
      ...
      chartParms.SetFieldIdxs (fieldIdxs);
    ...
    private void fetchDataTimer_Tick (object sender, System.EventArgs e)
    {
      ...
      if  (ticsSinceLastDisplay > 9)
      {
        ...
        {
          // We are plotting a depth chartParms.
          chartParms.PaintCurrentRow (currentDataRow);          
        }
        else
        {
          PaintChart ();
    ...
    private void  SetDepthRange ()
    {
      switch  (depthRange.SelectedOption)
      {
        ...
        case  "150 Meters": depthRangeInMeters = 150.0f; break;
    ...
    private void  SetChartRanges ()
    {
      ...
      chartParms.UpdateRanges (depthTop, depthBot);
    }  /* SetChartRanges */
    ...
    {
      if  ((chartParms == null)  ||  (rulerIdx < 0)  ||  (rulerIdx >= numOfRulers))
        return;
