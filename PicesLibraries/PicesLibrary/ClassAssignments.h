 ...
 *
 *         It is sub-classed from multimap<kkint16, MLClassConstPtr>.  This allows for fast lookup by
...
namespace MLL 
{
  ...
  class  ClassAssignments: public  std::multimap<kkint16, MLClassConstPtr>
  {
  public:
    ...
    */
    ...
    MLClassConstPtr      GetMLClass    (kkint16 num)  const;

    MLClassList          GetMLClasses (kkint16 num)  const;

    kkint16              GetNumForClass (MLClassConstPtr  mlClass)  const;
  ...
  private:
    typedef  std::map<MLClassConstPtr, kkint16>  ClassLookUp;
