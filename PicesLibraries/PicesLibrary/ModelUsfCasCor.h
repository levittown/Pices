...
namespace  MLL  
{
  ...
  public:
     ...
     * dictates the order of the classes. That is the probabilities for any given index in '_probabilities' will
     * be for the class specified in the same index in '_mlClasses'.
     ...
     *@param[out] _probabilities An array that must be as big as the number of classes as in mlClasses. The
     *                        probability of class in mlClasses[x] will be returned in probabilities[x].
    */
    virtual
