...
begin
  Insert into Deployments (CruiseName, StationName, DeploymentNum, Description, DateTimeStart, DateTimeEnd, Latitude, Longitude, SyncTimeStampActual, SyncTimeStampCTD, SyncTimeStampGPS)
         values (_cruiseName, _stationName, _deploymentNum, _description, _dateTimeStart, _dateTimeEnd, _latitude, _longitude, _syncTimeStampActual, _syncTimeStampCTD, _syncTimeStampGPS);
end
//
delimiter ;
