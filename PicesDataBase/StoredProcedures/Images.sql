...
begin 
  ...
  select sf.CruiseName                                                as CruiseName,
         ...
         sum((i.PixelCount >=  250)   and  (i.PixelCount <  300))     as Size__250,
         sum((i.PixelCount >=  300)   and  (i.PixelCount < 400))     as Size__300,
         sum((i.PixelCount >=  400)   and  (i.PixelCount < 500))     as Size__400,
         sum((i.PixelCount >=  500)   and  (i.PixelCount < 600))     as Size__500,
         sum((i.PixelCount >=  600)   and  (i.PixelCount < 700))     as Size__600,
         sum((i.PixelCount >=  700)   and  (i.PixelCount < 800))     as Size__700,
         sum((i.PixelCount >=  800)   and  (i.PixelCount < 900))     as Size__800,
         sum((i.PixelCount >=  900)   and  (i.PixelCount < 1000))    as Size__900,
         sum((i.PixelCount >= 1000)   and  (i.PixelCount < 1200))    as Size_1000,
         sum((i.PixelCount >= 1200)   and  (i.PixelCount < 1400))    as Size_1100,
         sum((i.PixelCount >= 1400)   and  (i.PixelCount < 1600))    as Size_1200,
         sum((i.PixelCount >= 1600)   and  (i.PixelCount < 1800))    as Size_1300,
         sum((i.PixelCount >= 1800)   and  (i.PixelCount < 2000))    as Size_1400,
         sum((i.PixelCount >= 2000)   and  (i.PixelCount < 2400))    as Size_1500,
         sum((i.PixelCount >= 2400)   and  (i.PixelCount < 2800))    as Size_1600,
         sum((i.PixelCount >= 2800)   and  (i.PixelCount < 3200))    as Size_1700,
         sum((i.PixelCount >= 3200)   and  (i.PixelCount < 3600))    as Size_1800,
         sum((i.PixelCount >= 3600)   and  (i.PixelCount < 4000))    as Size_1900,
         sum((i.PixelCount >= 4000)   and  (i.PixelCount < 4400))    as Size_2000,
         sum((i.PixelCount >= 4400)   and  (i.PixelCount < 4800))    as Size_2100,
         sum((i.PixelCount >= 4800)   and  (i.PixelCount < 5200))    as Size_2200,
         sum((i.PixelCount >= 5200)   and  (i.PixelCount < 5600))    as Size_2300,
         sum((i.PixelCount >= 5600)   and  (i.PixelCount < 6000))    as Size_2400,
         sum((i.PixelCount >= 6000)   and  (i.PixelCount < 6800))    as Size_2500,
         sum((i.PixelCount >= 6800)   and  (i.PixelCount < 7600))    as Size_2600,
         sum((i.PixelCount >= 7600)   and  (i.PixelCount < 8400))    as Size_2700,
         sum((i.PixelCount >= 8400)   and  (i.PixelCount < 9200))    as Size_2800,
         sum((i.PixelCount >= 9200)   and  (i.PixelCount < 10000))   as Size_2900,
         sum((i.PixelCount >= 10000)  and  (i.PixelCount < 10800))   as Size_3000,
         sum((i.PixelCount >= 10800)  and  (i.PixelCount < 11600))   as Size_3100,
         sum((i.PixelCount >= 11600)  and  (i.PixelCount < 12400))   as Size_3200,
         sum((i.PixelCount >= 12400)  and  (i.PixelCount < 13200))   as Size_3300,
         sum((i.PixelCount >= 13200)  and  (i.PixelCount < 14000))   as Size_3400,
         sum((i.PixelCount >= 14000)  and  (i.PixelCount < 15600))   as Size_3400,
         sum((i.PixelCount >= 15600)  and  (i.PixelCount < 17200))   as Size_3400,
         sum((i.PixelCount >= 17200)  and  (i.PixelCount < 18800))   as Size_3400,
         sum((i.PixelCount >= 18800)  and  (i.PixelCount < 20400))   as Size_3400,
         sum((i.PixelCount >= 20400)  and  (i.PixelCount < 22000))   as Size_4000,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4100,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4200,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4300,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4400,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4500,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4600,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4700,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4800,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_4900,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_5000,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_6000,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_7000,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_8000,
         sum((i.PixelCount >= )   and  (i.PixelCount < ))    as Size_9000,
         sum((i.PixelCount >= ))                                 as Size_10000
